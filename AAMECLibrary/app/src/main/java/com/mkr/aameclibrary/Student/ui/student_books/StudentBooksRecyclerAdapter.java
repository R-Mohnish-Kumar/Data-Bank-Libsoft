...
public class StudentBooksRecyclerAdapter extends  RecyclerView.Adapter<StudentBooksRecyclerAdapter.ViewHolder> {
    ArrayList<com.mkr.aameclibrary.BookDetails> BookDetails;
    Context context;

    public StudentBooksRecyclerAdapter(ArrayList<BookDetails> bookDetails, Context context) {
    ...
    @NonNull
    @Override
    public StudentBooksRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.books_row_item,parent,false);
        return new StudentBooksRecyclerAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull StudentBooksRecyclerAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
